...
export default function HistoryResearcher(props){
    ...
    const loadHistory = async () =>
    {
        ...
        if(researcherData) {
            const researcherContract = new web3.eth.Contract(MedicalReseachers.abi, researcherData.address)

            const hashesHistory = await researcherContract.methods.getFilesHistory(accounts[0]).call()
            let hash = ''
