...
export default function History(props){
    ...
    const loadHistory = async () =>
    {
        ...
        if(patientData) {
            const patientsContract = new web3.eth.Contract(Patients.abi, patientData.address)

            const patientObj = await patientsContract.methods.getPatient(accounts[0]).call()
