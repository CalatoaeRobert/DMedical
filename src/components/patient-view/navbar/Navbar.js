...
export default function Navbar(props) {
    ...
    return (
      ...
      <AppBar
        position="fixed"
        sx={{ width: `calc(100% - ${drawerWidth}px)`, ml: `${drawerWidth}px`, backgroundColor: "white", color: "black", borderRadius: 1}}
      >
        <Toolbar>
      ...
      >
        <List>
          ...
          <ListItem button onClick={() => navigate("/patients")}>
            ...
            <Badge text='20' textVariant='caption12'>
            </Badge>
          </ListItem>
          <ListItem button>
            <ListItemIcon>
          ...
          <ListItem button>
            ...
            <ListItemText primary="Investigation and prices" />
          </ListItem>
          <ListItem button>
            <ListItemIcon>
              <InboxIcon sx={{color: "#D8ECE4"}}/>
